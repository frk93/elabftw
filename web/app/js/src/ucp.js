...
(function() {
  ...
  $(document).ready(function() {
    ...
    $("#import_tpl")
      ...
      .on("change", function() {
        var title = document
          .getElementById("import_tpl")
          .value.replace(".elabftw.tpl", "")
          .replace("C:\\fakepath\\", "");
    ...
    tinymce.init({
      ...
      plugins:
        "table searchreplace code fullscreen insertdatetime paste charmap lists advlist save image imagetools link pagebreak mention codesample hr",
      ...
      mentions: {
        ...
        source: function(query, process) {
          let url =
            "app/controllers/EntityAjaxController.php?mention=1&term=" + query;
